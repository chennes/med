...
"nentitytype=Nombre de types d'entité utilisés (\ref med_entity_type)." \
...
"ngeotype=Nombre de types géométriques utilisés par des l'entités (\ref med_geometry_type)." \
"lgeotype=Liste des types géométriques utilisés par des l'entités (\ref med_geometry_type)." \
...
"sortingtype=Ordre de tri des étapes de calcul dans le maillage (#MED_SORT_DTIT ou #MED_SORT_ITDT)." \
...
"nstep=Nombre d'étapes de calcul (taille de la séquence de calcul)." \
...
"changement=Indicateur de changement par rapport à l'étape de calcul précédente." \
"transformation=Indicateur de transformation par rapport à l'étape de calcul précédente." \
...
\
"MEDmeshComputationStepCrBrief=Cette routine permet de créer une nouvelle étape de calcul dans un maillage." \
"MEDmeshComputationStepCrDetails=Cette routine permet de créer une nouvelle étape de calcul dans un maillage.\
 Une étape de calcul est identifiée par un couple numéro de pas de temps / numéro d'itération. Une date est associée au pas de temps. \
 \li Si les deux pas de temps et numéro d'itération passés en paramètres sont différents,\
 la première étape passée en paramètre correspond à l'étape de calcul précédant l'étape de calcul à créer.\
 l'étape de calcul à créer s'insère alors entre deux étapes de calcul existantes. \
 \li Si les deux pas de temps et numéro d'itération passés en paramètres sont identiques,\
 l'étape de calcul à créer s'insère alors en tant que dernière étape (si les valeurs sont cohérentes). \
 Si l'étape de calcul à créer existe déjà, une erreur est renvoyée." \
\
"MEDmeshComputationStepInfoBrief= Cette routine permet de lire les informations relatives à une étape de calcul d'un maillage." \
"MEDmeshComputationStepInfoDetails= Cette routine permet de lire les informations relatives à une étape de calcul d'un maillage. L'accès à l'étape de calcul se fait via un itérateur. Les informations lues sont : le numéro de pas de temps, le numéro d'itération, la valeur du pas de temps. \
\li Une étape de calcul est identifiée par les paramètres <i>numdt</i> et <i>numit</i> (les valeurs renvoyées peuvent être #MED_NO_DT et #MED_NO_IT). \
...
\li le mode de tri des étapes de calcul (ordre d'accès aux étapes de calcul) :\
...
"MEDmeshElementConnectivityAdvancedRdBrief=Cette routine permet de lire dans un maillage le tableau des connectivités pour un type géométrique d'un élément,\
 selon une étape de calcul et un filtre donnés." \
...
\
"MEDmeshElementConnectivityAdvancedWrBrief=Cette routine permet d'écrire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul et un filtre donnés." \
"MEDmeshElementConnectivityAdvancedWrDetails=Cette routine permet d'écrire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul et un filtre donnés.\
 ...
 Quelque soit le mode de connectivité (nodale/descendante), la numérotation optionnelle n'est jamais utilisée dans la définition des connectivités.  " \
\
"MEDmeshElementConnectivityRdBrief=Cette routine permet de lire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul donnée." \
"MEDmeshElementConnectivityRdDetails=Cette routine permet de lire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul donnée. A noter que le : \
...
\
"MEDmeshElementConnectivityWrBrief=Cette routine permet d'écrire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul donnée." \
"MEDmeshElementConnectivityWrDetails=Cette routine permet d'écrire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul donnée. A noter que : \
\li Le type de l'entite est soit une maille (connectivité nodale ou descendante), une face (connectivité descendante uniquement) ou une arête (connectivité descendante uniquement). \
\li Quelque soit le mode de connectivité (nodale/descendante), la numérotation optionnelle n'est jamais utilisée dans la définition des connectivités. \
\li Le mode de stockage du tableau de connectivité en mémoire est soit entrelacé ou non entrelacé." \
"MEDmeshElementConnectivityRdBrief=Cette routine permet de lire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul donnée." \
\
"MEDmeshElementConnectivityWithProfileRdBrief=Cette routine permet de lire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul et un profil donnés." \
"MEDmeshElementConnectivityWithProfileRdDetails=Cette routine permet de lire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul et un profil donnés.\
...
\li Le mode de stockage du tableau de connectivité en mémoire est soit entrelacé ou non entrelacé." \
\
"MEDmeshElementConnectivityWithProfileWrBrief=Cette routine permet d'écrire dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul et un profil donnés." \
"MEDmeshElementConnectivityWithProfileWrDetails=Cette routine permet d'écrier dans un maillage le tableau des connectivités pour un type géométrique d'un élément, selon une étape de calcul et un profil donnés.\
 Le profil est identifié par un nom et le mode de stockage des données en mémoire peut être paramétré : compact ou global. A noter que le : \
\li Le type de l'entite est soit une maille (connectivité nodale ou descendante), une face (connectivité descendante uniquement) ou une arête (connectivité descendante uniquement). \
\li Quelque soit le mode de connectivité (nodale/descendante), la numérotation optionnelle n'est jamais utilisée dans la définition des connectivités. \
\li Le mode de stockage du tableau de connectivité en mémoire est soit entrelacé ou non entrelacé." \
...
"MEDmeshGeotypeParameterDetails=Cette routine renvoie les caractéristiques d'une maille de type géométrique \a geotype en connectivité nodale. \
 ...
 Le type géométrique \a geotype peut être celui d'un élément de structure local au fichier identifié par \fid." \
\
"MEDmeshGlobalNumberWrBrief=Cette routine permet l'écriture d'une numérotation globale sur un maillage pour un type d'entité, un type géométrique et une étape de calcul donnés." \
"MEDmeshGlobalNumberWrDetails=Cette routine permet l'écriture d'une numérotation globale sur un maillage pour un type d'entité, un type géométrique et une étape de calcul donnés.\
...
\
"MEDmeshGlobalNumberRdBrief=Cette routine permet la lecture d'une numérotation globale sur un maillage pour un type d'entité, un type géométrique et une étape de calcul donnés." \
"MEDmeshGlobalNumberRdDetails=Cette routine permet la lecture d'une numérotation globale sur un maillage pour un type d'entité, un type géométrique et une étape de calcul donnés.\
 Les numéros globaux sont obligatoirement supérieur à 1. Un maillage distribué est entièrement déterminé par la donnée des maillages affectés à chacun des sous-domaines,\
 par la définition de « joints » - raccord entre les maillages de sous-domaines voisins et par une numérotation globale optionnelle des entités. " \
\
...
\li son type : structuré ou non structuré ; \
\li le repère des coordonnées définies selon la dimension de l'espace de calcul : cartésien, sphérique, cylindrique. \
\li le mode de tri des étapes de calcul (ordre d'accès aux étapes de calcul) : en privilégiant les pas de temps sur les numéro d'itération (#MED_SORT_DTIT) ou inversement (#MED_SORT_ITDT) ; \
\li le nombre de étapes de calcul présentes dans le maillage. " \
\
...
\li le nombre de étapes de calcul présentes dans le maillage. " \
\
"MEDmeshNodeCoordinateAdvancedRdBrief=Cette routine permet de lire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul et un filtre donnés." \
"MEDmeshNodeCoordinateAdvancedRdDetails=Cette routine permet de lire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul et un filtre donnés. Cette routine est une routine dite avancée car le paramètre correspondant au filtre permet de sélectionner finement les données lues en mode séquentiel ou parallèle : avec ou sans profil, mode d'entrelacement, par blocs, etc." \
\
"MEDmeshNodeCoordinateAdvancedWrBrief=Cette routine permet d'écrire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul et un filtre donnés." \
"MEDmeshNodeCoordinateAdvancedWrDetails=Cette routine permet d'écrire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul et un filtre donnés. Cette routine est une routine dite avancée car le paramètre correspondant au filtre permet de sélectionner finement les données lues en mode séquentiel ou parallèle : avec ou sans profil, mode d'entrelacement, par blocs, etc." \
...
\
"MEDmeshNodeCoordinateRdBrief=Cette routine permet de lire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul donnée." \
"MEDmeshNodeCoordinateRdDetails=Cette routine permet de lire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul donnée. Le mode de stockage du tableau de coordonnées en mémoire est entrelacé ou non entrelacé." \
"MEDmeshNodeCoordinateWrBrief=Cette routine permet d'écrire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul donnée." \
"MEDmeshNodeCoordinateWrDetails=Cette routine permet d'écrire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul donnée. Le mode de stockage du tableau de coordonnées en mémoire est entrelacé ou non entrelacé." \
\
"MEDmeshNodeCoordinateWithProfileWrBrief=Cette routine permet d'écrire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul donnée et un profil donnés." \
"MEDmeshNodeCoordinateWithProfileWrDetails=Cette routine permet d'écrire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul et un profil donnés. Le profil est identifié par un nom et le mode de stockage des données en mémoire peut être paramétré : compact ou global. Le mode de stockage du tableau de coordonnées en mémoire est entrelacé ou non entrelacé." \
...
\
"MEDmeshNodeCoordinateWithProfileRdBrief=Cette routine permet de lire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul donnée et un profil donnés." \
"MEDmeshNodeCoordinateWithProfileRdDetails=Cette routine permet de lire dans un maillage le tableau des coordonnées des noeuds, selon une étape de calcul et un profil donnés. Le profil est identifié par un nom et le mode de stockage des données en mémoire peut être paramétré : compact ou global. Le mode de stockage du tableau de coordonnées en mémoire est entrelacé ou non entrelacé." \
\
...
\
"MEDmeshnEntityBrief=Cette routine permet de lire le nombre d'entités dans un maillage pour une étape de calcul donnée." \
...
L'indicateur \a changement indique un changement dans le maillage par rapport à l'étape de calcul précédente (exemple : nouvelles coordonnées des noeuds).\
 Si cet indicateur est à #MED_TRUE, l'indicateur \a transformation indique pour l'étape de calcul considérée et le type d'entité concerné un changement\
 géométrique (exemple : modification des connectivités des mailles). \
\MEDmeshnEntityDetails2 " \
"MEDmeshnEntityWithProfileBrief=Cette routine permet de lire le nombre d'entités dans un maillage pour une étape de calcul et un profil donnés." \
...
Le profil est identifié par un nom et le mode de stockage des données en mémoire peut être paramétré : #MED_COMPACT_STMODE ou #MED_GLOBAL_STMODE .\
 L'indicateur \a changement indique un changement dans le maillage par rapport à l'étape de calcul précédente (exemple : nouvelles coordonnées des noeuds).\
 Si cet indicateur est à #MED_TRUE, l'indicateur \a tranbsformation indique pour l'étape de calcul considérée et le type d'entité concerné un changement\
 géométrique (exemple : modification des connectivités des mailles). \
Cette routine retourne selon la valeur des paramètres et en tenant compte du mode de stockage du profil : \
\MEDmeshnEntityDetails2 " \
\
"MEDmeshNodeWrBrief=Cette routine permet l'écriture des noeuds d'un maillage non structuré pour une étape de calcul donnée." \
"MEDmeshNodeWrDetails=Cette routine permet l'écriture des noeuds d'un maillage non structuré pour une étape de calcul donnée.\
...
"MEDmeshNodeRdBrief=Cette routine permet la lecture des noeuds d'un maillage non structuré pour une étape de calcul donnée." \
"MEDmeshNodeRdDetails=Cette routine permet la lecture des noeuds d'un maillage non structuré pour une étape de calcul donnée.\
...
"MEDmeshNodeWrDetails=Cette routine permet l'écriture des noeuds d'un maillage non structuré pour une étape de calcul donnée.\
 ...
 des données optionnelles." \
\
"MEDmeshElementWrBrief=Cette routine permet l'écriture d'un type d'élément d'un maillage non structuré pour une étape de calcul donnée." \
"MEDmeshElementWrDetails=Cette routine permet l'écriture d'un type d'entité d'un maillage non structuré pour une étape de calcul donnée. Les données écrites sont le tableau des connectivités, les noms (optionnel), les numéros (optionnel), les numéros de familles (optionnel si tous égaux à 0). Les booléens associés aux tableaux permettent d'indiquer la présence des données optionnelles." \
"MEDmeshElementRdBrief=Cette routine permet la lecture d'un type d'élément d'un maillage non structuré pour une étape de calcul donnée." \
...
\
"MEDmeshNodeCoordinateTrsfWrBrief=Cette routine définit les paramètres de translation rotation à appliquer aux noeuds de l'étape de calcul \a numdt \a numo du maillage \a meshname." \
...
"MEDmeshNodeCoordinateTrsfRdBrief=Cette routine lit les paramètres de translation rotation à appliquer aux noeuds de l'étape de calcul \a numdt \a numo\
...
\
"MEDmeshSortingTypeRdBrief=Cette routine lit l'ordre de tri des étapes évolutives du maillage." \
"MEDmeshSortingTypeRdDetails=Cette routine lit l'ordre de tri des étapes évolutives du maillage.\
 Le mode de tri (ordre d'accès aux étapes de calcul) consiste à privilégier les pas de temps sur les numéro d'itération (#MED_SORT_DTIT) ou inversement (#MED_SORT_ITDT)." \
\
