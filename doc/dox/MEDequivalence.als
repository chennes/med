...
"nocstpncorrespondence=Nombre de tableaux de correspondances sur l'étape de calcul." \
...
\li Le nombre d'étapes de calcul dans le maillage sur lesquelles sont dédinies des tableaux de correspondance pour cette équivalence, \
\li Le nombre de tableau de correspondances sur la première étape de calcul." \
"MEDequivalenceComputingStepInfoBrief=Cette routine permet de lire les informations relatives à une équivalence pour une étape de calcul donnée." \
"MEDequivalenceComputingStepInfoDetails=Cette routine permet de lire les informations relatives à une équivalence pour une étape de calcul donnée. L'accès à l'étape de calcul se fait via un itérateur. Les informations lues sont : \
\li Le numéro de pas de temps de l'étape de calcul, \
\li Le numéro d'ordre de l'étape de calcul, \
\li Le nombre de tableau de correspondances dans cette étape de calcul." \
"MEDequivalenceCorrespondenceSizeBrief=Cette routine permet de lire le nombre de correspondances dans une équivalence pour une étape de calcul et un type d'entité donnés." \
"MEDequivalenceCorrespondenceSizeDetails=Cette routine permet de lire le nombre de correspondances dans une équivalence pour une étape de calcul et un type d'entité donnés. Le type géométrique peut être : \
...
"MEDequivalenceCorrespondenceSizeInfoBrief= Cette routine permet de lire les informations relatives à un tableau de correspondances dans une équivalence pour une étape de calcul donnée." \
...
"MEDequivalenceCorrespondenceRdBrief=Cette routine permet de lire un tableau de correspondances entre les entités d'un maillage dans une équivalence pour une étape de calcul et un type d'entité donnés." \
"MEDequivalenceCorrespondenceRdDetails=Cette routine permet de lire un tableau de correspondances entre les entités d'un maillage dans une équivalence pour une étape de calcul et un type d'entité donnés. Le tableau des correspondances est un tableau à 1 dimension où les correspondances sont rangées 2 à 2. Le type géométrique peut être : \
\li Pour les noeuds (MED_NODE) : MED_NONE. \
\li Pour les mailles (MED_CELL) : MED_POINT1, MED_SEG2, MED_SEG3, MED_SEG4, MED_TRIA3, MED_TRIA6, MED_TRIA7, MED_QUAD4, MED_QUAD8, MED_QUAD9, MED_POLYGON. \
\li Pour les faces (MED_DESCENDING_FACE) : MED_TRIA3, MED_TRIA6, MED_TRIA7, MED_QUAD4, MED_QUAD8, MED_QUAD9, MED_POLYGON. \
\li Pour les arêtes (MED_DESCENDING_EDGE) : MED_SEG2, MED_SEG3, MED_SEG4." \
"MEDequivalenceCorrespondenceWrBrief=Cette routine permet d'écrire un tableau de correspondances entre les entités d'un maillage dans une équivalence pour une étape de calcul et un type d'entité donnés." \
