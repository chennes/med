...
"MEDsubdomainCorrespondenceRdBrief=Cette routine permet la lecture d'une correspondance dans un joint pour un type de couple d'entité en regard et une étape de calcul donnés." \
...
\li Pour les faces (MED_DESCENDING_FACE) : MED_TRIA3, MED_TRIA6, MED_TRIA7, MED_QUAD4, MED_QUAD8, MED_QUAD9, MED_POLYGON. \
\li Pour les arêtes (MED_DESCENDING_EDGE) : MED_SEG2, MED_SEG3, MED_SEG4." \
"MEDsubdomainComputingStepInfoBrief=Cette routine permet de lire les informations sur les correspondances entre types d'entités dans un maillage pour chaque étape de calcul." \
...
"MEDsubdomainCorrespondenceSizeBrief=Cette routine permet la lecture du nombre d'entités en correspondance dans un joint pour un couple d'entités et une étape de calcul donnés." \
"MEDsubdomainCorrespondenceSizeDetails=Cette routine permet la lecture du nombre d'entités en correspondance dans un joint pour un couple d'entités et une étape de calcul donnés." \
"MEDsubdomainCorrespondenceSizeInfoBrief=Cette routine permet de lire les informations sur les couples d'entités en correspondance dans un joint pour une étape de calcul donnée." \
"MEDsubdomainCorrespondenceSizeInfoDetails=Cette routine permet de lire les informations sur les couples d'entités en correspondance dans un joint pour une étape de calcul donnée. L'accès aux correspondances se fait via un itérateur, les informations lues sont : les types d'entités en correspondance entre les sous-domaines et le nombre d'entités en correspondance." \
