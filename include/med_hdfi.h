...
#define _MEDattributeInt8Wr(w,x,y)  _MEDattributeNumWr(w,x, MED_INTERNAL_INT8, (unsigned char *) y)
#define _MEDattributeInt32Wr(w,x,y)  _MEDattributeNumWr(w,x, MED_INTERNAL_INT32, (unsigned char *) y)
...
#define _MEDattrEntierLire(x,y,z)  _MEDattrNumLire(x,MED_INT           , y,  (void * const) z)
#define _MEDattributeInt8Rd(x,y,z) _MEDattrNumLire(x, MED_INTERNAL_INT8, y,  (void * const) z)
#define _MEDattributeInt32Rd(x,y,z) _MEDattrNumLire(x, MED_INTERNAL_INT32, y,(void * const) z)
#define _MEDattrFloatLire(x,y,z)   _MEDattrNumLire(x,MED_FLOAT64       , y,  (void * const) z)
