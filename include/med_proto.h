...
extern MEDC_EXPORT int      _MEDtest8bits(uint8_t int_type,int offset);
extern MEDC_EXPORT uint8_t  _MEDnSet8bits(uint8_t int_type);
extern MEDC_EXPORT void     _MEDset8bits (uint8_t * const int_type,int offset);

extern MEDC_EXPORT int      _MEDtest32bits(uint32_t int_type,int offset);
extern MEDC_EXPORT uint32_t  _MEDnSet32bits(uint32_t int_type);
extern MEDC_EXPORT void     _MEDset32bits (uint32_t * const int_type,int offset);
