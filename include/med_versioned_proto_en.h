...
MEDC_EXPORT extern void  _MEDfieldValueAdvancedWr41(int dummy,...);
MEDC_EXPORT extern void  _MEDfieldnEntityType41(int dummy,...);
MEDC_EXPORT extern void  _MEDfieldEntityType41(int dummy,...);
MEDC_EXPORT extern void  _MEDfieldnGeometryType41(int dummy,...);
MEDC_EXPORT extern void  _MEDfieldGeometryType41(int dummy,...);
