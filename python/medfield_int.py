...
MED_5_LATEST_MINOR = _medfield.MED_5_LATEST_MINOR
MED_50_LATEST_RELEASE = _medfield.MED_50_LATEST_RELEASE
...
class MEDINT64(object):
    ...
    def iterator(self):
        return _medfield.MEDINT64_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _medfield.MEDINT64___nonzero__(self)

    def __bool__(self):
        return _medfield.MEDINT64___bool__(self)

    def __len__(self):
        return _medfield.MEDINT64___len__(self)

    def __getslice__(self, i, j):
        return _medfield.MEDINT64___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _medfield.MEDINT64___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _medfield.MEDINT64___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _medfield.MEDINT64___delitem__(self, *args)

    def __getitem__(self, *args):
        return _medfield.MEDINT64___getitem__(self, *args)

    def __setitem__(self, *args):
        return _medfield.MEDINT64___setitem__(self, *args)

    def pop(self):
        return _medfield.MEDINT64_pop(self)

    def append(self, x):
        return _medfield.MEDINT64_append(self, x)

    def empty(self):
        return _medfield.MEDINT64_empty(self)

    def size(self):
        return _medfield.MEDINT64_size(self)

    def swap(self, v):
        return _medfield.MEDINT64_swap(self, v)

    def begin(self):
        return _medfield.MEDINT64_begin(self)

    def end(self):
        return _medfield.MEDINT64_end(self)

    def rbegin(self):
        return _medfield.MEDINT64_rbegin(self)

    def rend(self):
        return _medfield.MEDINT64_rend(self)

    def clear(self):
        return _medfield.MEDINT64_clear(self)

    def get_allocator(self):
        return _medfield.MEDINT64_get_allocator(self)

    def pop_back(self):
        return _medfield.MEDINT64_pop_back(self)

    def erase(self, *args):
        return _medfield.MEDINT64_erase(self, *args)

    def __init__(self, *args):
        _medfield.MEDINT64_swiginit(self, _medfield.new_MEDINT64(*args))

    def push_back(self, x):
        return _medfield.MEDINT64_push_back(self, x)

    def front(self):
        return _medfield.MEDINT64_front(self)

    def back(self):
        return _medfield.MEDINT64_back(self)

    def assign(self, n, x):
        return _medfield.MEDINT64_assign(self, n, x)

    def resize(self, *args):
        return _medfield.MEDINT64_resize(self, *args)

    def insert(self, *args):
        return _medfield.MEDINT64_insert(self, *args)

    def reserve(self, n):
        return _medfield.MEDINT64_reserve(self, n)

    def capacity(self):
        return _medfield.MEDINT64_capacity(self)

    def __iadd__(self, value):
        return _medfield.MEDINT64___iadd__(self, value)

    def __add__(self, value):
        return _medfield.MEDINT64___add__(self, value)

    def __isub__(self, value):
        return _medfield.MEDINT64___isub__(self, value)

    def __sub__(self, value):
        return _medfield.MEDINT64___sub__(self, value)

    def __imul__(self, value):
        return _medfield.MEDINT64___imul__(self, value)

    def __mul__(self, value):
        return _medfield.MEDINT64___mul__(self, value)

    def __itruediv__(self, *args):
        return _medfield.MEDINT64___itruediv__(self, *args)
    __idiv__ = __itruediv__



    def __truediv__(self, *args):
        return _medfield.MEDINT64___truediv__(self, *args)
    __div__ = __truediv__



    def __le__(self, value):
        return _medfield.MEDINT64___le__(self, value)

    def __lt__(self, value):
        return _medfield.MEDINT64___lt__(self, value)

    def __gt__(self, value):
        return _medfield.MEDINT64___gt__(self, value)

    def __ge__(self, value):
        return _medfield.MEDINT64___ge__(self, value)

    def __eq__(self, value):
        return _medfield.MEDINT64___eq__(self, value)

    def __ne__(self, value):
        return _medfield.MEDINT64___ne__(self, value)
    __swig_destroy__ = _medfield.delete_MEDINT64

# Register MEDINT64 in _medfield:
_medfield.MEDINT64_swigregister(MEDINT64)
