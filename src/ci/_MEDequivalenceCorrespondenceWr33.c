...
void
_MEDequivalenceCorrespondenceWr33(int dummy, ...) {
  ...
  /* Il est possible de faire des équivalences de mailles 3D dans le cadre de raccords
     non conformes depuis la 3.3.0 */
  /* if ( (geotype / 100 ) > 2 )  { */
  /*   MED_ERR_(_ret,MED_ERR_RANGE,MED_ERR_GEOMETRY,MED_ERR_EQUIVALENCE_MSG); */
