...
/**\ingroup MEDfield
  \brief \MEDfieldnEntityTypeBrief
  \param fid \fid
  \param fieldname \fieldname
  \param numdt \numdt
  \param numit \numit
  \retval med_int \nentitytype \n \error
  \details \MEDfieldnEntityTypeDetails
  \remarks
  \MEDfieldnEntityTypeRem1
...
{
  char *  name = "_MEDfieldnEntityType";
  int     dummy=0;
  med_int fret=-1;
  ...
  /*
    Les modèles de données internes < 41 n'ont pas les meta données
