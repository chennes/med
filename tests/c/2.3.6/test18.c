...

{
  ...
  if ((fid = MEDouvrir("test18.med",MODE_ACCES)) < 0) {
   ...
   */
  if (! MEDformatConforme("test18.med"))
   ...
   */
  if (! MEDversionConforme("test18.med"))
  ...
  if ((fid = MEDouvrir("test18.med",MED_LECTURE)) < 0) {
   ...
   */
  if (MEDversionLire(fid, &majeur, &mineur, &release) < 0) {
