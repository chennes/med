...

{
 ...
 /* Caractéristiques du model n° 3 sans points de gauss pour le champ n°1*/
  ...
  /* enregistre la composante n°1 des éléments de valr3, et n'utilise ni pas de temps ni n° d'ordre */
  ...
  /* enregistre les composantes des éléments de valr3, et n'utilise ni pas de temps ni n° d'ordre */
