...
case $file in
       ...
       ;;
       test10*) medint="${MEDINT}"
                test "x${CPYMED}" = "xyes" && ${CP} ${SRCDIR}/test.med.ref ${BUILDDIR}/${file}.med && chmod 644 ${BUILDDIR}/${file}.med
       ;;
       test20) 
                ${CP} ${BUILDDIR}/test2.med ${BUILDDIR}/test20-0.med && chmod 644 ${BUILDDIR}/test20-0.med 
                (test -f ${SRCDIR}/dumps.ref/test10f${MEDINT}.med && test ! -f ${BUILDDIR}/test10.med ) && ${CP} ${SRCDIR}/dumps.ref/test10f${MEDINT}.med ${BUILDDIR}/test10-0.med && chmod 644 ${BUILDDIR}/test10-0.med || ${CP} ${BUILDDIR}/test10.med ${BUILDDIR}/test10-0.med && chmod 644 ${BUILDDIR}/test10-0.med
