...
exec(compile(open(os.path.join(os.path.dirname(__file__),'test10_TEST_PARAMS_PY_')).read(), os.path.join(os.path.dirname(__file__),'test10_TEST_PARAMS_PY_'), 'exec'),locals(),globals())
