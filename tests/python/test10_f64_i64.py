...
exec(compile(open(os.path.join(os.path.dirname(__file__),'test10_params_f64_i64.py')).read(), os.path.join(os.path.dirname(__file__),'test10_params_f64_i64.py'), 'exec'),locals(),globals())
