...
exec(compile(open(os.path.join(os.path.dirname(__file__),'test10_params_f64_i32.py')).read(), os.path.join(os.path.dirname(__file__),'test10_params_f64_i32.py'), 'exec'),locals(),globals())
