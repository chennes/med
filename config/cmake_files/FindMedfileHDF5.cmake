...
"The two paths are: ${_tmp_ROOT_DIR}   and   ${_HDF5_ROOT_DIR_ENV}")
  ...
  # Expose HDF5 MPI Root Directory to the rest of the world
  IF(HDF5_ENABLE_PARALLEL)
      ...
      # EF: GET_PROPERTY(_lib_lst TARGET hdf5 PROPERTY IMPORTED_LINK_INTERFACE_LIBRARIES_NOCONFIG)
      # EF: Since hdf5-1.10, hdf5 target use a prefix 
      # GET_PROPERTY(_lib_lst TARGET ${HDF5_LIBRARIES} PROPERTY INTERFACE_LINK_LIBRARIES)
      # EF: FOREACH(s ${_lib_lst})
      # EF :Since hdf5-1.10, hdf5 target do not use property for MPI stuff 
      FOREACH(s ${HDF5_MPI_C_INCLUDE_PATH})
        # EF : STRING(FIND "${s}" "mpi." _res)   # should cover WIN(?) and LINUX
